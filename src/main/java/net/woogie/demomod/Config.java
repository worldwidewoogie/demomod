...
public class Config {
	...
	public static final Object[] itemRecipe = new Object[] { //
			"S S", //
			" S ", //
			"S S", //
			'S', Items.stick };
	...
	public static final Object[] swordRecipe = new Object[] { //
			" X ", //
			" X ", //
			" S ", //
			'S', Items.stick, //
	...
	public static final Object[] pickaxeRecipe = new Object[] { //
			"XXX", //
			" X ", //
			" S ", //
			'S', Items.stick, //
	...
	public static final Object[] helmetRecipe = new Object[] { //
			"XXX", //
			"X X", //
			'X', DemoMod.demoItem };
	...
	public static final Object[] chestplateRecipe = new Object[] { //
			"X X", //
			"XXX", //
			"XXX", //
			'X', DemoMod.demoItem };
	...
	public static final Object[] leggingsRecipe = new Object[] { //
			"XXX", //
			"X X", //
			"X X", //
			'X', DemoMod.demoItem };
	...
	public static final Object[] bootsRecipe = new Object[] { //
			"X X", //
			"X X", //
			'X', DemoMod.demoItem };
	...
	public static final Object[] foodRecipe = new Object[] { //
			"X  ", //
			"X  ", //
			'X', DemoMod.demoItem };
	...
	public static final List<SpawnListEntry> biomeSpawnList = new ArrayList<SpawnListEntry>() {{
        // new SpawnListEntry(EntityToSpawn.class, spawnRate, spawnMin, spawnMax);
